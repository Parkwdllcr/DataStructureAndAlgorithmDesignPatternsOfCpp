...
#ifndef __UTILS_BOX_UTILS_H__
#define __UTILS_BOX_UTILS_H__
...
/// \struct stSystemTime utilsbox_utils.h
...
#define UTILSBOX_StrTrimLeftSpace(Macro_Input_Str,  Macro_Input_Len) \
{   \
...
#define UTILSBOX_StrTrimSpace(Macro_Input_Str,  Macro_Input_Len) \
{   \
    const char* pcMacroInnerTmpStr = (Macro_Input_Str); \
    if ( 0!=(Macro_Input_Len) ) \
    { \
